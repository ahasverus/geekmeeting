...
Launch the [`make.R`](https://github.com/ahasverus/geekmeeting/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/ahasverus/geekmeeting/blob/main/CONTRIBUTING.md).
